<template>
  ...
  >
    <!-- Drawer-->
    <Drawer id="drawer" :isDrawerOpen="true" :menu="getDrawerMenu('home')" />
    <!-- Page Content -->
    <div
      id="container"
      class="
...
import UiClasses from "./classes/UiClasses.vue";
...
function getToolbarMenu(key: string): Array<MenuItem> {
  let list: Array<MenuItem> = new Array<MenuItem>();
  switch (key) {
    case "home":
